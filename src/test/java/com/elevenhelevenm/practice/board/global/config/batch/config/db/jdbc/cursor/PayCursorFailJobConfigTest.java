...
import com.elevenhelevenm.practice.board.global.config.batch.config.db.jpa.cursor.PayCursorFailJobConfig;
...
@SpringBatchTest
@SpringBootTest(classes = {PayCursorFailJobConfig.class, TestBatchConfig.class})
class PayCursorFailJobConfigTest {
    ...
    @Test
    @DisplayName("같은 조건을 읽고 업데이트 할 때 - 해결 예시 1")
    void batchCursorTest() throws Exception {
        //given
        for (long i = 0; i < 50; i++) {
