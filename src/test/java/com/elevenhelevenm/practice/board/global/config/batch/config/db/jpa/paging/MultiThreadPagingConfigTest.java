...
@SpringBatchTest
@SpringBootTest(classes = {MultiThreadPagingConfig.class, TestBatchConfig.class})
@TestPropertySource(properties = {"chunkSize=1", "poolSize=1"})
class MultiThreadPagingConfigTest {
    ...
    @Test
    @DisplayName("Paging 분산처리 된다.")
    void pagingByParallel() throws Exception {
        //given
